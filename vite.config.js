            ...
            targets: [
                {
                    ...
                    src: [
                        ...
                        'nasa_data/clusters/medium_quad1_a.json',
                        'nasa_data/clusters/medium_quad1_b.json',
                        'nasa_data/clusters/medium_quad2.json',
                        'nasa_data/clusters/medium_quad3.json',
                        'nasa_data/clusters/medium_quad4.json',
                        'nasa_data/clusters/far_quad1_a.json',
                        'nasa_data/clusters/far_quad1_b.json',
                        'nasa_data/clusters/far_quad2.json',
                        'nasa_data/clusters/far_quad3.json',
                        'nasa_data/clusters/far_quad4.json',
                        'nasa_data/clusters/veryfar_quad1_a.json',
                        'nasa_data/clusters/veryfar_quad1_b.json',
